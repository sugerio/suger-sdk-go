...
func (r ApiAddContactToBuyerRequest) Execute() (*IdentityBuyer, *http.Response, error) {
...
func (a *ContactAPIService) AddContactToBuyerExecute(r ApiAddContactToBuyerRequest) (*IdentityBuyer, *http.Response, error) {
	var (
