...
// checks if the GithubComSugerioMarketplaceServicePkgLegacyRdsDbLibBillingAwsBillingEvent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GithubComSugerioMarketplaceServicePkgLegacyRdsDbLibBillingAwsBillingEvent{}

// GithubComSugerioMarketplaceServicePkgLegacyRdsDbLibBillingAwsBillingEvent struct for GithubComSugerioMarketplaceServicePkgLegacyRdsDbLibBillingAwsBillingEvent
type GithubComSugerioMarketplaceServicePkgLegacyRdsDbLibBillingAwsBillingEvent struct {
...
// NewGithubComSugerioMarketplaceServicePkgLegacyRdsDbLibBillingAwsBillingEvent instantiates a new GithubComSugerioMarketplaceServicePkgLegacyRdsDbLibBillingAwsBillingEvent object
...
func NewGithubComSugerioMarketplaceServicePkgLegacyRdsDbLibBillingAwsBillingEvent() *GithubComSugerioMarketplaceServicePkgLegacyRdsDbLibBillingAwsBillingEvent {
	this := GithubComSugerioMarketplaceServicePkgLegacyRdsDbLibBillingAwsBillingEvent{}
	return &this
}

// NewGithubComSugerioMarketplaceServicePkgLegacyRdsDbLibBillingAwsBillingEventWithDefaults instantiates a new GithubComSugerioMarketplaceServicePkgLegacyRdsDbLibBillingAwsBillingEvent object
...
func (o GithubComSugerioMarketplaceServicePkgLegacyRdsDbLibBillingAwsBillingEvent) MarshalJSON() ([]byte, error) {
...
func (o GithubComSugerioMarketplaceServicePkgLegacyRdsDbLibBillingAwsBillingEvent) ToMap() (map[string]interface{}, error) {
...
type NullableGithubComSugerioMarketplaceServicePkgLegacyRdsDbLibBillingAwsBillingEvent struct {
	value *GithubComSugerioMarketplaceServicePkgLegacyRdsDbLibBillingAwsBillingEvent
	isSet bool
}

func (v NullableGithubComSugerioMarketplaceServicePkgLegacyRdsDbLibBillingAwsBillingEvent) Get() *GithubComSugerioMarketplaceServicePkgLegacyRdsDbLibBillingAwsBillingEvent {
	return v.value
}

func (v *NullableGithubComSugerioMarketplaceServicePkgLegacyRdsDbLibBillingAwsBillingEvent) Set(val *GithubComSugerioMarketplaceServicePkgLegacyRdsDbLibBillingAwsBillingEvent) {
	v.value = val
	v.isSet = true
}

func (v NullableGithubComSugerioMarketplaceServicePkgLegacyRdsDbLibBillingAwsBillingEvent) IsSet() bool {
	return v.isSet
}

func (v *NullableGithubComSugerioMarketplaceServicePkgLegacyRdsDbLibBillingAwsBillingEvent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGithubComSugerioMarketplaceServicePkgLegacyRdsDbLibBillingAwsBillingEvent(val *GithubComSugerioMarketplaceServicePkgLegacyRdsDbLibBillingAwsBillingEvent) *NullableGithubComSugerioMarketplaceServicePkgLegacyRdsDbLibBillingAwsBillingEvent {
	return &NullableGithubComSugerioMarketplaceServicePkgLegacyRdsDbLibBillingAwsBillingEvent{value: val, isSet: true}
}

func (v NullableGithubComSugerioMarketplaceServicePkgLegacyRdsDbLibBillingAwsBillingEvent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGithubComSugerioMarketplaceServicePkgLegacyRdsDbLibBillingAwsBillingEvent) UnmarshalJSON(src []byte) error {
	v.isSet = true
